      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-10">
          ...
          >
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">{t("hero.title")}</h1>
            <p className="mx-auto max-w-[700px] text-muted-foreground text-lg md:text-xl">{t("hero.subtitle")}</p>
          </motion.div>
